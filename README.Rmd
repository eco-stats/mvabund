...
[![CRAN status](https://www.r-pkg.org/badges/version/mvabund)](https://CRAN.R-project.org/package=mvabund)
[![](http://cranlogs.r-pkg.org/badges/last-month/mvabund)](https://cran.r-project.org/package=mvabund)
[![Codecov test coverage](https://codecov.io/gh/eco-stats/mvabund/branch/master/graph/badge.svg)](https://app.codecov.io/gh/eco-stats/mvabund?branch=master)
...
Thanks for finding the bug! We would appreciate it if you can pop over to our [Issues page](https://github.com/eco-stats/mvabund/issues) and describe how to reproduce the bug! 
...
### mvabund in action
Check out the list of studies that uses `mvabund` in their analyses [here](https://scholar.google.com.au/scholar?cites=2455431763697722063)
